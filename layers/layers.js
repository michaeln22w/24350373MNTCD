...
var format_20092022_29 = new ol.format.GeoJSON();
var features_20092022_29 = format_20092022_29.readFeatures(json_20092022_29, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_20092022_29 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_20092022_29.addFeatures(features_20092022_29);
var lyr_20092022_29 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_20092022_29, 
                style: style_20092022_29,
                popuplayertitle: "2009 - 2022",
                interactive: true,
                title: '<img src="styles/legend/20092022_29.png" /> 2009 - 2022'
            });
var format_19922008_30 = new ol.format.GeoJSON();
var features_19922008_30 = format_19922008_30.readFeatures(json_19922008_30, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_19922008_30 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_19922008_30.addFeatures(features_19922008_30);
var lyr_19922008_30 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_19922008_30, 
                style: style_19922008_30,
                popuplayertitle: "1992 - 2008",
                interactive: true,
                title: '<img src="styles/legend/19922008_30.png" /> 1992 - 2008'
            });
var format_AllWindFarmsto2022_31 = new ol.format.GeoJSON();
var features_AllWindFarmsto2022_31 = format_AllWindFarmsto2022_31.readFeatures(json_AllWindFarmsto2022_31, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AllWindFarmsto2022_31 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AllWindFarmsto2022_31.addFeatures(features_AllWindFarmsto2022_31);
var lyr_AllWindFarmsto2022_31 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AllWindFarmsto2022_31, 
                style: style_AllWindFarmsto2022_31,
                popuplayertitle: "All Wind Farms to 2022",
                interactive: true,
                title: '<img src="styles/legend/AllWindFarmsto2022_31.png" /> All Wind Farms to 2022'
            });
var group_WindFarmData = new ol.layer.Group({
                                layers: [lyr_2022Now_28,lyr_20092022_29,lyr_19922008_30,lyr_AllWindFarmsto2022_31,],
                                fold: "open",
...
var group_RenewableEnergyGenerationIreland = new ol.layer.Group({
                                layers: [lyr_AllSubstationsIreland_4,lyr_PowerLinesRepublicofIreland_5,lyr_PowerGeneratorPointROI_6,lyr_Solar_7,lyr_PowerPlantROI_8,lyr_WindTurbinesIreland_9,],
                                fold: "open",
...
lyr_20092022_29.set('fieldImages', {'Windfarm_N': '', 'DSO_TSO': '', 'Connection': '', 'County': '', 'Present_St': '', 'Installed_': '', 'MEC__MW_': '', 'Gate': '', 'F110kV_Nod': '', 'Target_Con': '', 'Date_of_Co': '', 'Year_of_Co': '', 'Nat_Grid_E': '', 'Nat_Grid_N': '', 'Type': '', });
lyr_19922008_30.set('fieldImages', {'Windfarm_N': '', 'DSO_TSO': '', 'Connection': '', 'County': '', 'Present_St': '', 'Installed_': '', 'MEC__MW_': '', 'Gate': '', 'F110kV_Nod': '', 'Target_Con': '', 'Date_of_Co': '', 'Year_of_Co': '', 'Nat_Grid_E': '', 'Nat_Grid_N': '', 'Type': '', });
lyr_AllWindFarmsto2022_31.set('fieldImages', {'Windfarm_N': 'TextEdit', 'DSO_TSO': 'TextEdit', 'Connection': 'TextEdit', 'County': 'TextEdit', 'Present_St': 'TextEdit', 'Installed_': 'TextEdit', 'MEC__MW_': 'TextEdit', 'Gate': 'TextEdit', 'F110kV_Nod': 'TextEdit', 'Target_Con': 'TextEdit', 'Date_of_Co': 'TextEdit', 'Year_of_Co': 'TextEdit', 'Nat_Grid_E': 'TextEdit', 'Nat_Grid_N': 'TextEdit', 'Type': 'TextEdit', });
...
lyr_20092022_29.set('fieldLabels', {'Windfarm_N': 'no label', 'DSO_TSO': 'no label', 'Connection': 'no label', 'County': 'no label', 'Present_St': 'no label', 'Installed_': 'no label', 'MEC__MW_': 'no label', 'Gate': 'no label', 'F110kV_Nod': 'no label', 'Target_Con': 'no label', 'Date_of_Co': 'no label', 'Year_of_Co': 'no label', 'Nat_Grid_E': 'no label', 'Nat_Grid_N': 'no label', 'Type': 'no label', });
lyr_19922008_30.set('fieldLabels', {'Windfarm_N': 'no label', 'DSO_TSO': 'no label', 'Connection': 'no label', 'County': 'no label', 'Present_St': 'no label', 'Installed_': 'no label', 'MEC__MW_': 'no label', 'Gate': 'no label', 'F110kV_Nod': 'no label', 'Target_Con': 'no label', 'Date_of_Co': 'no label', 'Year_of_Co': 'no label', 'Nat_Grid_E': 'no label', 'Nat_Grid_N': 'no label', 'Type': 'no label', });
lyr_AllWindFarmsto2022_31.set('fieldLabels', {'Windfarm_N': 'no label', 'DSO_TSO': 'no label', 'Connection': 'no label', 'County': 'no label', 'Present_St': 'no label', 'Installed_': 'no label', 'MEC__MW_': 'no label', 'Gate': 'no label', 'F110kV_Nod': 'no label', 'Target_Con': 'no label', 'Date_of_Co': 'no label', 'Year_of_Co': 'no label', 'Nat_Grid_E': 'no label', 'Nat_Grid_N': 'no label', 'Type': 'no label', });
lyr_AllWindFarmsto2022_31.on('precompose', function(evt) {
